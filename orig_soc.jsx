...
const HeroBlock = () => (
    <section className="text-center mb-28 soc-fade-in">
        ...
        <h1 className="font-display text-4xl md:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
            SOC Lab ΓÇö Network Segmentation<br />
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   BLOCK 2 ΓÇö Animated Network Topology (all inline SVG styles)
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
const TopologyBlock = () => {
            ...
            <div className="card-wrapper max-w-4xl mx-auto">
                <div className="card-content p-4 sm:p-8 overflow-x-auto">
                    <svg viewBox="0 0 820 520" style={{ width: '100%', height: 'auto', minWidth: 620 }} xmlns="http://www.w3.org/2000/svg">
                        ...
                        <text x="155" y="180" textAnchor="middle" style={svgText({ fontSize: 12, fill: '#2dd4bf' })}>LAN ΓÇö 192.168.10.0/24</text>
                        {/* Wazuh Manager box */}
                        ...
                        <text x="645" y="160" textAnchor="middle" style={svgText({ fontSize: 12, fill: '#f59e0b' })}>DMZ ΓÇö 192.168.20.0/24</text>
                        {/* SafeLine WAF box */}
                        ...
                        {/* ΓöÇΓöÇΓöÇ TEST Zone (Kali) ΓöÇΓöÇΓöÇ */}
                        ...
                        <text x="410" y="400" textAnchor="middle" style={svgText({ fontSize: 12, fill: '#ef4444' })}>TEST ΓÇö 192.168.30.0/24</text>
                        ...
                        {/* ΓöÇΓöÇΓöÇ pfSense Central Node ΓöÇΓöÇΓöÇ */}
                        ...
                        {/* ΓöÇΓöÇΓöÇ Connection lines ΓöÇΓöÇΓöÇ */}
                        {/* pfSense ΓåÆ LAN */}
                        ...
                        {/* ΓöÇΓöÇΓöÇ ANIMATED ATTACK PATH (red dot: Kali ΓåÆ pfSense ΓåÆ WAF ΓåÆ BLOCKED) ΓöÇΓöÇΓöÇ */}
                        ...
                        {/* ΓöÇΓöÇΓöÇ ANIMATED CLEAN TRAFFIC (green dot: Kali ΓåÆ pfSense ΓåÆ WAF ΓåÆ DVWA) ΓöÇΓöÇΓöÇ */}
                        ...
                        <g opacity="0">
                            ...
                            <text x="645" y="273" textAnchor="middle" style={{ fontSize: 14, fill: '#22c55e' }}>Γ£ô</text>
                        </g>


                        {/* ΓöÇΓöÇΓöÇ Legend ΓöÇΓöÇΓöÇ */}
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   BLOCK 3 ΓÇö Defense Layers (staggered slide-in)
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
const defenseLayers = [
    {
...
/* ΓöÇΓöÇΓöÇ Mini Animated Visualizers for Defense Layers ΓöÇΓöÇΓöÇ */
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   BLOCK 4 ΓÇö Attack Flow (sequential stepper)
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
const attackSteps = [
            ...
            <div className="max-w-4xl mx-auto overflow-x-auto pb-4">
                                    ...
                                    >
                                        {step.isDecision ? (
                                            <div className="flex gap-1.5 text-lg">
                                                <span style={{ color: '#ef4444' }}>Γ£ò</span>
                                                <span style={{ color: '#22c55e' }}>Γ£ô</span>
                                            </div>
                                        ) : (
                ...
                <div className="flex justify-center gap-6 mt-6">
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-red-500/20 bg-red-500/5">
                        ...
                        <span className="text-xs text-red-400 font-medium">Blocked payloads ΓåÆ red glow on WAF</span>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-green-500/20 bg-green-500/5">
                        <span className="w-2 h-2 rounded-full bg-green-500"></span>
                        <span className="text-xs text-green-400 font-medium">Clean traffic ΓåÆ passes through</span>
                    </div>
                </div>
            </div>
        </section>
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   BLOCK 5 ΓÇö WAF Test Results Table
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
const testResults = [
    { attack: 'Command injection', payload: '127.0.0.1; whoami', tool: 'SafeLine WAF', result: 'Blocked', emoji: '≡ƒö┤', status: 'red' },
    { attack: 'File inclusion', payload: '?page=../../../etc', tool: 'SafeLine WAF', result: 'Blocked', emoji: '≡ƒö┤', status: 'red' },
    { attack: 'File upload', payload: 'php-reverse-shell.php', tool: 'SafeLine WAF', result: 'Blocked', emoji: '≡ƒö┤', status: 'red' },
    { attack: 'SQL injection', payload: "admin' OR '1'='1", tool: 'SafeLine WAF', result: 'Blocked', emoji: '≡ƒö┤', status: 'red' },
    { attack: 'XSS', payload: "<script>alert('XSS')</script>", tool: 'SafeLine WAF', result: 'Blocked', emoji: '≡ƒö┤', status: 'red' },
    { attack: 'NIDS test traffic', payload: 'curl testmynids.org', tool: 'Suricata', result: 'Detected', emoji: '≡ƒƒí', status: 'yellow' },
    { attack: 'SSH brute force', payload: 'ssh wronguser@host', tool: 'Wazuh', result: 'Detected', emoji: '≡ƒƒí', status: 'yellow' },
    { attack: 'FIM ΓÇö file created', payload: 'touch samplefile.txt', tool: 'Wazuh FIM', result: 'Detected', emoji: '≡ƒƒí', status: 'yellow' },
];
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   BLOCK 6 ΓÇö Monitoring Pipeline (animated data flow)
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
...
/* Individual stat card ΓÇö each is its own component so hooks are safe */
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   DOCUMENTATION ΓÇö Project Overview
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
const OverviewBlock = () => {
    const [ref, inView] = useInView();
    const objectives = [
                    ...
                    <div className="card-wrapper">
                        <div className="card-content p-8">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed mb-6">
                                This project demonstrates an end-to-end Security Operations Center (SOC) lab built entirely using open-source tools in a virtualized environment. The lab simulates a real enterprise network divided into three isolated zones ΓÇö LAN, DMZ, and TEST ΓÇö connected through a pfSense firewall. Each zone serves a distinct purpose: the LAN hosts the Wazuh SIEM manager along with endpoint clients, the DMZ exposes a deliberately vulnerable web application (DVWA) behind a SafeLine WAF, and the TEST zone provides an attacker machine (Kali Linux) for controlled penetration testing.
                            </p>
                            <p className="text-slate-400 text-sm leading-relaxed mb-8">
                                The primary goal is to validate a layered defense-in-depth strategy by launching real attack payloads and verifying that each security layer ΓÇö firewall rules, intrusion detection signatures, WAF filters, and SIEM alerts ΓÇö responds correctly.
                            </p>
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   DOCUMENTATION ΓÇö Tool Configurations
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
const toolConfigs = [
    {
        ...
        config: [
            ...
            'LAN  ΓåÆ vtnet1 ΓåÆ 192.168.10.1/24',
            'DMZ  ΓåÆ vtnet2 ΓåÆ 192.168.20.1/24',
            'TEST ΓåÆ vtnet3 ΓåÆ 192.168.30.1/24',
            '',
            '# Firewall Rules (simplified)',
            'PASS  TEST ΓåÆ DMZ:443    # Allow WAF access',
            'PASS  TEST ΓåÆ DMZ:8080   # Allow DVWA',
            'BLOCK TEST ΓåÆ LAN:*      # Isolate attacker',
            'PASS  LAN  ΓåÆ ANY        # LAN full access',
        ],
    },
    {
        name: 'Suricata IDS',
        ...
        config: [
            ...
            '  - custom-nids.rules',
            '',
            '# eve-log output ΓåÆ /var/log/suricata/eve.json',
    ...
    },
    {
        ...
        config: [
            ...
            'Γ£ô SQL Injection Detection',
            'Γ£ô XSS Filter (reflected + stored)',
            'Γ£ô Command Injection Blocker',
            'Γ£ô Path Traversal / LFI Guard',
            'Γ£ô File Upload Scanner',
        ],
    },
    {
        name: 'Wazuh SIEM',
...
/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
   DOCUMENTATION ΓÇö Key Findings & Lessons
   ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
const findings = [
    ...
    { title: 'End-to-End Visibility Achieved', desc: 'By forwarding Suricata and system logs to Wazuh, a single dashboard provided complete visibility across all three network zones ΓÇö from network-level intrusions to application-layer attacks.', color: '#ef4444' },
];
